...
public class Exercises {
	...
	public boolean posNeg(int a, int b, boolean negative) {
		return ((a<0 && b<0) && negative) ? true : (a/b < 0 && !negative) ? true : false;
	}
	...
	public boolean in3050(int a, int b) {
		return (a>=30 && b>=30) && (a<=40 && b<=40)? true : (a>=40 && b>=40) && (a<=50 && b<=50) ? true : false;
	}
	...
	public int dateFashion(int you, int date) {
		return (date>=8 && you>=8) ? 2 : (date<=2 || you<=2) ? 0 : (date>=8 || you>=8) ? 2 : 1;
	}
	...
	public boolean squirrelPlay(int temp, boolean isSummer) {
		return  (isSummer && temp<=100 && temp>=60) ? true : (temp>=60 && temp<=90) ? true : false;
	}
    ...
    public String yourCakeAndEatItToo(double mealAmount, boolean isBirthday) {
		...
		return (mealAmount <=10) ? "standard" : (mealAmount <=15) ? "special" : "ginormous";
    }
	...
	public String alarmClock(int day, boolean vacation) {
		 return (day !=0 && day !=6 && !vacation) ? "7:00" : (day !=0 && day !=6 && vacation) ? "10:00" : ((day == 0 || day == 6) && !vacation) ? "10:00" : "off";
	}
	...
	public boolean in1To10(int n, boolean outsideMode) {
		return ((n<=10 && n>=1) && !outsideMode) ? true : (outsideMode && (n<=1 || n>=10)) ? true : false;
	}
	...
	public boolean nearTen(int num) {
		return ((num) % 10 == 0 || (num) % 10 == 2 || (num+2) % 10 == 0 || (num) % 10 == 1 || (num+1) % 10 == 0) ? true : false;
	}
	...
	public int loneSum(int a, int b, int c) {
		int a1 =(a==b)?0:(c==a)?0:a;
		int b1 =(b==c)?0:(a==b)?0:b;
		int c1 =(c==a)?0:(b==c)?0:c;
		return a1+b1+c1;
	}

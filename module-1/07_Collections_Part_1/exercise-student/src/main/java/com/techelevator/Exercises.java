...
public class Exercises {
	...
	public List<String> array2List(String[] stringArray) {
		List<String> list1 =new ArrayList<>(List.of(stringArray));
		return list1;
	}
	...
	public String[] list2Array(List<String> stringList) {
		...
		String[] x = stringList.toArray(new String[0]);
	...
	public List<Double> arrayInt2ListDouble(int[] intArray) {
		...
		for(double divide : intArray) {
			doubles.add(divide/2);
		}
		return doubles;
	}
	...
	public Integer findLargest(List<Integer> integerList) {
		...
		int largest = integerList.get(integerList.size()-1);
		return largest;
	}
	...
	public boolean foundIntTwice(List<Integer> integerList, int intToFind) {
		int count = 0;
		for (Integer lookFor : integerList) {
			if (lookFor == intToFind) {
				count++;
			}
		}
	...
	** INTERVIEW QUESTION **
	...
	public List<String> fizzBuzzList(Integer[] integerArray) {
		...
		String b = "Buzz";
		String fB = "FizzBuzz";
		List<String> fbNum = new ArrayList<>();

		for(Integer multiple : integerArray) {
			String fbNumAdd = multiple.toString();
